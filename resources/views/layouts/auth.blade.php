...
<html lang="en">
	...
	<head>
		...
		<!--end::Web font -->
        <link href="{{ asset('erwintheme/vendors/vendors/line-awesome/css/line-awesome.css') }}" rel="stylesheet" type="text/css" />
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
		...
		<!-- <script src="{{ asset('erwintheme/assets/snippets/custom/pages/user/login.js') }}" type="text/javascript"></script> -->
		<script>
            var toastForm = ``;
            var toastInfo = ``;
            var toastError = ``;
